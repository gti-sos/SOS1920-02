...
<main>
    ...
    <br><br>
    <p style="text-align: center;"> A continuación podrás elegir el grupo que desees para hacer la comparación con repositorios de compañeros de la asignatura de Sistemas Orientados a Servicios.</p>
    <br><br>       
    ...
    <br><br>
    <button type="button" class="btn btn-secondary" onclick="window.location.href='#/integrations/evolution-of-cycling-routes/apiExterna01'"style="margin-left: 30.25%; width: 20%;"> API Externa I</button>
    <button type="button" class="btn btn-secondary" onclick="window.location.href='#/integrations/evolution-of-cycling-routes/apiExterna02'"style="width: 20%;"> API Externa II</button>
</main>
